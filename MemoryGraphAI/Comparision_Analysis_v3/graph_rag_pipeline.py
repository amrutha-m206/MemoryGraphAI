...
#         """
#         Builds a RELATIONAL context string.
#         Format: (EntityA) -[RELATION]-> (EntityB) | description
#         This is what makes Graph RAG's context structurally richer than Vector RAG's.
#         """
...
#                 src_desc = self.graph["entities"].get(src, "")[:60]
#                 lines.append(f"({src}) --[{rel_readable}]--> ({tgt})")

#         return "\n".join(lines)

#     def answer_question(self, question: str, llm_fn) -> str:
#         """Generate an answer using the graph context and the provided LLM function."""
#         context = self.get_context_string(question)
#         if not context.strip():
#             return "No relevant information found in the knowledge graph."

#         prompt = (
#             "You are an expert research assistant. You have been given a knowledge graph "
#             "context containing structured relationships between concepts.\n\n"
#             "Knowledge Graph Context (relationship triples):\n"
#             f"{context}\n\n"
#             "Using ONLY the relationships shown above, answer the following question. "
#             "Reason step by step through the connections between entities.\n\n"
#             f"Question: {question}\n\n"
#             "Answer:"
#         )
