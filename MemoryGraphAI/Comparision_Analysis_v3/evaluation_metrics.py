...
# 2. FAITHFULNESS [1-5]: Is the answer factually accurate and well-grounded?
#    1=Contains major errors or hallucinations, 3=Mostly correct with minor issues, 5=Completely accurate

# 3. COMPLETENESS [1-5]: Does the answer cover all key aspects of the question?
